            ...
            <main className="flex flex-col items-center ">
                ...
                <form className="flex max-[1278px]:flex-col w-full  bg-white/75 p-7 gap-6 rounded-2xl border-2 border-midGreen  shadow-lg shadow-darkGreen/50">
                    ...
                    <div className="flex flex-col max-[1278px]:w-[100%]">
                        ...
                        <DatePicker selected={startDate} onChange={(date:Date|null) => setStartDate(date!)} className="rounded-lg border border-midGreen text-[#757575] max-[1278px]:w-full focus:font-semibold focus:border focus:border-darkGreen focus:ring-0 focus:text-darkGreen"/>
                                            </div>
                    <div className="flex flex-col max-[1278px]:w-[100%]">
                        <label htmlFor="dateEnd" className="text-darkGreen pb-1 pl-1 ">Date de fin</label>
                        <DatePicker selected={endDate} onChange={(date:Date|null) => setEndDate(date!)} className="rounded-lg border border-midGreen text-[#757575] max-[1278px]:w-full focus:font-semibold focus:border focus:border-darkGreen focus:ring-0 focus:text-darkGreen"/>
                    </div>
                    <div className="flex flex-col max-[1278px]:w-[100%]">

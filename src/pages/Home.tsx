    ...
    return (
        <div className="bg-cover bg-center home-background h-[95vh] flex flex-col items-center justify-center">
            <main className="flex flex-col items-center ">
                ...
                <form className="flex max-[1066px]:flex-col w-full  bg-white/75 p-7 gap-6 rounded-2xl border-2 border-midGreen items-end shadow-lg shadow-darkGreen/50">
                    <div className="flex flex-col max-[1066px]:w-[100%]">
                        <label htmlFor="where" className="text-darkGreen pb-1 pl-1">Où ?</label>
                        <div className="relative">
                            <button type="button" name="where" id="where" className="max-[1066px]:w-full w-[270px] rounded-lg border border-midGreen bg-white py-2 px-3 text-[#757575] flex justify-between focus:text-darkGreen focus:font-medium" onClick={toggleSelected}><span>{location===null?"Choissisez une région":`${location}`}</span>
                                {!isSelectedToggle ?
                            ...
                            {isSelectedToggle &&
                                <div className="absolute top-[50px] bg-white rounded-lg py-1 px-2 border border-midGreen">
                    ...
                    <div className="flex flex-col max-[1066px]:w-[100%]">
                        ...
                        <input type="date" name="dateStart" id="dateStart" className=" rounded-lg border border-midGreen text-[#757575] focus:font-semibold focus:border focus:border-darkGreen focus:ring-0 focus:text-darkGreen" />
                    </div>
                    <div className="flex flex-col max-[1066px]:w-[100%]">
                        <label htmlFor="dateEnd" className="text-darkGreen pb-1 pl-1 max-[992px]:w-full">Date de fin</label>
                        <input type="date" name="dateEnd" id="dateEnd" className=" rounded-lg border border-midGreen text-[#757575] focus:font-semibold focus:border focus:border-darkGreen focus:ring-0 focus:text-darkGreen" />
                    </div>
                    <div className="flex flex-col max-[1066px]:w-[100%]">
                        <label htmlFor="person" className="text-darkGreen pb-1 pl-1 max-[992px]:w-full">Combien de personne ?</label>
                        <input type="number" name="person" id="person" min="1" max="4" placeholder="4 pers. max" className="rounded-lg  border border-midGreen focus:border focus:border-darkGreen focus:ring-0 focus:placeholder:text-darkGreen" onChange={handleGuests} />
                    </div>
                    <div className="flex flex-col max-[1066px]:w-[100%] max-[1066px]:text-center">
